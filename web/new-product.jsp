                                                ...
                                                <c:when test="${empty ROLE}">
                                                    ...
                                                    <form id="logoutForm" action="MainController">
                                                        <li>
                                                            ...
                                                            <a href="#" id="logoutLink"><i class="icon-key"></i> <span>Logout</span></a></li>
                                                    </form>
                                                </c:when>
                                            </c:choose>
                                        </ul>
                                ...
                                <div class="wrapper-content">
                                    <form method="POST" action="MainController" enctype="multipart/form-data">
                                        <div class="form-group mt-3">
                                            ...
                                            <input type="text" placeholder="Product name ex: Giày thể thao" value="${txtProductName}"  name="txtProductName" required class="form-control">
                                        </div>
                                        <div class="form-group mt-3">
                                            <label>Description</label>
                                            <input type="text" placeholder="Description ex: Luôn tạo cho bạn một sự thoải mái nhất mỗi khi đi trên chân." value="${txtDescription}"name="txtDescription" class="form-control">
                                        </div>
                                        <div class="form-group mt-3">
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <input type="number" min="1000" step="4" value="${txtSalePrice}" name="txtSalePrice" placeholder="Sale Price" required class="form-control">
                                        </div>
                                        <div class="form-group mt-3">
                                            <label>Import Price</label>
                                            <input type="number" min="1000" step="4" value="${txtImportPrice}" name="txtImportPrice" placeholder="Import Price" required class="form-control">
                                        </div>
