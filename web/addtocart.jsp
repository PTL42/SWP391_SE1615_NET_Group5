...
<html>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th class="text-center gui_productname">Image <i
                                                            class="text-danger">*</i></th>
                                                    <th class="text-center gui_productname">Product Name<i
                                                            class="text-danger">*</i></th>
                                                    <th class="text-center">Quantity</th>
                                                 
                                                    <th class="text-center">Price<i class="text-danger">*</i>
                                                    </th>
                                        ...
                                        <h1>Total:${sessionScope.cart.size()}</h1>
                                        <!-- row -->
                                        <form  id="from1">
    ...
    <script type="text/javascript">
                function buy22(id) {
                    document.f.action = "addtocart2?id=" + id;
                    document.f.submit();
                }
