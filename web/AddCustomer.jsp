                                ...
                                <div class="card-body">
                                    <div class="form-validation">
                                        <form class="form-valide" action="AddCustomer" method="post">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="val-website"> Detail <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-8 ml-auto">
                                                    <button type="summit" class="btn btn-primary" onclick="return confirm('Are you Sure')">Add</button>
                                                </div>
                                            </div>
