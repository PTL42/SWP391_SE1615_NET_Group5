...
<html class="h-100" lang="en">
                                ...
                                <div class="card-body pt-5">
                                    ...
                                    <form action="draft" method="post" class="mt-5 mb-3 login-input">
                                        <div class="form-group">
                                            <input type="hidden" value="ok1,ok,ok2," class="form-control" name="password" id="password" placeholder="name" required onChange="onChange()">
                                        </div>
                                        <div class="form-group">
    ...
    ***********************************-->
    ...
    <script>
        var productquantitytoday = $("#password").val();
                ...
                var productquantitytoday = splitbslabe2.split(",");
                  ...
                  console.log(productquantitytoday);
                   for (var i = 0, max = productquantitytoday.length; i < max; i++) {
        $('#password, #confirm_password').on('keyup', function () {
           
    

            if (productquantitytoday[i] == $('#confirm_password').val()) {
