        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div style="padding: 0 20%; margin-top: 10px ">
                    ...
                    <c:if test="${not empty SMS_LOGIN}">
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>Note:</strong> <span class="font-weight-semi-bold text-capitalize">${SMS_LOGIN} </span>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </c:if>
                </div>

                <!--Search Product by parameter with role ADMIN-->
                                                ...
                                                <tbody>
                                                    <c:forEach items="${LIST_PRODUCT}" var="product">
                                                        <tr class="text-center">
                                                            ...
                                                            <td>
                                                                <fmt:setLocale value = "vi_VN"/>
                                                                <fmt:formatNumber value = "${product.cost}"/> VND
                                                            </td>
                                                            <td>
                                ...
                                <c:if test="${LIST_CATEGORY != null}">
                                    <c:if test="${not empty LIST_CATEGORY}">
                                        <form action="MainController" method="POST">
                                            <ul>
                                                <li>
                                                    <button name="btnAction" value="Search Product" class="btn btn-outline-secondary w-100">
                                                        All Product
                                                    </button>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="col-lg-3 col-md-6 mt-5 mb-4 mb-lg-0">
                                                <div class="card rounded shadow-sm border-1">
                                                    ...
                                                    <form action="MainController" method="POST">
                                                        <div class="d-flex justify-content-center mt-3 mb-3">
                                                            <button class="btn btn-outline-dark">
                                                                <input type="hidden" name="btnAction" value="Login First">
                                                                <input name="txtProductID" type="hidden" value="${product.productID}">
                                                                ADD TO CART
                                                            </button>
                                                        </div>
