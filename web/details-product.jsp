                                    ...
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <div class="form-group mt-3 img-thumbnail">
                                                <img class="rounded mx-auto d-block" id="uploadPreview" src="${context}/${PRODUCT.productImage}" style="width: 75%; height: 50%" />
                                            </div>
                                        </div>
                                        <div class="col-5">
                                            <div class="row w-100">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="mt-3" style="border: none; outline: none; background: none">
                                                        ${PRODUCT.category.typeCategory}
                                                    </div>
                                                    <div class="mt-3">
                                                        ${PRODUCT.quantity}
                                                    </div>
