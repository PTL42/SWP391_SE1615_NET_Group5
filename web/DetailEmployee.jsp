                            ...
                            <div class="card-body">
                                <div class="media align-items-center mb-4">
                                    ...
                                    <div class="media-body">
                                        <h3 class="mb-0" value >${pr.employeeName}</h3>
                                        <p class="text-muted mb-0">${pr.dob}</p>
                                        <p class="text-muted mb-0">${pr.gender}</p>
                                    </div>
                                </div>
                                ...
                                <ul class="card-profile__info">
                                    ...
                                    <li><strong class="text-dark mr-4">Detail</strong> <span></span></li>
                                </ul>
