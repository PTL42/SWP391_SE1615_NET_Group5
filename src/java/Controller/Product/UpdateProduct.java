    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equalsIgnoreCase("Go To Update Page")) {
                ...
                updatedProduct.setStatus(Boolean.valueOf(slStatus));
                ...
                if (isSuccess) {
                    ...
                    request.setAttribute("UPDATE_CAKE_MSG_SUCCESS", "Update Cake (" + updatedProduct.getProductName() + ") Success ");
                    request.setAttribute("PRODUCT_DETAIL", updatedProduct);
                } else {
                    url = Define.UPDATE_PRODUCT_PAGE;
                    request.setAttribute("UPDATE_CAKE_MSG_FAILED", "Update Cake(" + updatedProduct.getProductName() + ") Failed ");
                    request.setAttribute("PRODUCT_DETAIL", product);
                }
            }
